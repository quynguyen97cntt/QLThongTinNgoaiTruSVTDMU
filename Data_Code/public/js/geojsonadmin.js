...
var khutro = L.geoJson(geojsonFeature, {
    onEachFeature: function (feature, layer) {
        layer.bindPopup('<div style="width: 400px; font-weight: bold; font-size: 14px;">- Tên nhà trọ: ' + feature.properties.tennhatro.replace(/\"/g, "") + '<br /> - Tên chủ trọ: ' + feature.properties.tenchutro.replace(/\"/g, "") + '<br /> - Điện thoại: ' + feature.properties.dienthoai + '<br /> - Giá phòng: <span style="color: red;">' + ((feature.properties.giaphong.replace(/\"/g, "")==0)?'Chưa cập nhật':feature.properties.giaphong.replace(/\"/g, "")+ ' vnđ/tháng ')  + ' </span> <br /> - Điện: <span style="color: red;">' + (feature.properties.dien.replace(/\"/g, "")==0?'Chưa cập nhật':feature.properties.dien.replace(/\"/g, "")+ ' vnđ/kWh ')  + ' </span> <br /> - Nước: <span style="color: red;">' + (feature.properties.nuoc.replace(/\"/g, "")==0?'Chưa cập nhật':feature.properties.nuoc.replace(/\"/g, "") + ' vnđ/m3 ') + ' </span> <br /> - Số người trong một phòng: ' + (feature.properties.soluong.replace(/\"/g, "")==0?'Chưa cập nhật':feature.properties.soluong.replace(/\"/g, "") + ' người ' ) + ' <br /> - Trạng thái: <span style="color: red;">' + (feature.properties.trangthai.replace(/\"/g, "")==0?'Chưa cập nhật':feature.properties.trangthai.replace(/\"/g, "")) + '</span> <br /> - Cách trường TDMU: <span style="color: red;">' + feature.properties.khoangcach+ ' km (đường chim bay) </span> ' + '<br /> - Địa chỉ: ' + feature.properties.diachi.replace(/\"/g, "")  +"</div>");
    }
}).addTo(map);
