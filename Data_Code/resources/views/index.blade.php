    ...
    <div class="card-body">
        <div>
            ...
            <div class="row justify-content-center form-group col-md-12" style="padding: 0 !important"> 
                <div class="col-md-3">
                        <form class="form-group col-sm-12 col-md-12">
                                <input type="checkbox" id="lopvung" checked onClick="ShowHideClass()">
                                <label for="lopvung" class="font-weight-bold mr-2 mt-2">Lớp vùng</label>

                                <input type="checkbox" id="lopdiem" checked onClick="ShowHideClass()">
                                <label for="lopdiem" class="font-weight-bold mr-2 mt-2">Lớp điểm</label>
                        </form>

                        <label class="font-weight-bold mr-2 ml-2 mt-2">Xem theo lớp</label>
                        <form action="{{route('/')}}" method="GET" id="frmLocGiaPhong" class="form-group col-sm-12 col-md-12">
                        @csrf
                        ...
                        <form class="form-group col-sm-12 col-md-12">
                            ...
                            <label for="statusStudentsTC" class="font-weight-bold">Có sinh viên</label>
                        </form>
                        <label class="font-weight-bold ml-2 mr-2 mt-2">Phóng to</label>

                        <form class="form-group col-sm-12 mr-5 col-md-12">
                        ...
                        <form action="{{route('timkiemkhunhatro')}}" method="GET" class="form-group col-sm-12 col-md-12">
                            <input class="form-control" name="timkhutro" type="text" placeholder="Nhập tên chủ trọ, tên nhà trọ...">
                        </form>
                </div>
                <div class="col-md-9" id="contentchange">
