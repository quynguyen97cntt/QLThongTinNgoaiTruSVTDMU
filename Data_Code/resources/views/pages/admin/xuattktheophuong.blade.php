<table class="table" border="1">
    <thead>
        <tr>
            <td style="font-size: 18px; font-weight: bold;" colspan="12">BẢNG THỐNG KÊ SỐ LƯỢNG NHÀ TRỌ LIÊN KẾT VỚI TDMU THEO PHƯỜNG</td>
        </tr>
    <tr>
        <th style="font-size: 14px; font-weight: bold;">STT</th>
        <th style="font-size: 14px; font-weight: bold;" colspan="6">Tên phường</th>
        <th style="font-size: 14px; font-weight: bold;" colspan="5">Số lượng nhà trọ</th>
    </tr>
    </thead>
    <tbody>
      <?php $i=1 ?>
