    ...
    <div class="card-header">
        <div class="row float-left" style="font-size: 20px;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-primary" href="{{ route('quan-ly-khu-tro')}}"></a></li>
                    <li class="breadcrumb-item"><a class="text-primary" href="{{ route('quan-ly-khu-tro')}}">Quản lý khu trọ</a></li>
